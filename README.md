...
1. Login to the Cloud IDE and familiarize yourself with the user interface. See the [Cloud IDE Product Documentation](https://docs.acquia.com/ide/) for more information.
