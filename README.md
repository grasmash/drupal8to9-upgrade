...
1. The IDE will take 10-15 minutes to provision. You will see it listed alongside your other environments such as Dev, Stage, and Prod.
1. Once provisioning is complete, click **Launch IDE** and login to the Cloud IDE and familiarize yourself with the user interface. See the [Cloud IDE Product Documentation](https://docs.acquia.com/ide/) for more information.
